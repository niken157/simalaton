...
<div class="card">
    ...
    <form action="/kartu_peserta/store" method="post">
        {{ csrf_field() }}
        <div class="mb-3">
            <label for="id_peserta">NAMA PESERTA :</label><br>
            <select class="selectpicker" data-live-search="true" name="id_peserta" data-width="100%" class="form-select" id="id_peserta" visibleOptions="true">
                @php
