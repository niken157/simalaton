...
<br>
    ...
    <div class="card-header">
        <span style=" font-size: 1cm;">
            ...
            <a class="align-items-center justify-content-between btn btn-danger" onclick="return confirm('Apakah Anda Yakin Menghapus Semua Data?')" href="/kartu_peserta/hapus_semua" role="button"><i class="fas fa-fw fa-trash"></i> Hapus Semua</a>
