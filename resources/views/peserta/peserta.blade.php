...
<br>
    ...
    <div class="card-header">
            ...
            <a class="align-items-center justify-content-between btn btn-danger" onclick="return confirm('Apakah Anda Yakin Menghapus Semua Data?')" href="/peserta/hapus_semua" role="button"><i class="fas fa-fw fa-trash"></i> Hapus Semua</a>
        </div>
        <div class="card-body table-responsive">
            ...
            <p>* untuk melihat format import, silahkan mengeksport terlebih dahulu.</p>
