                ...
                <tbody>
                    ...
                    @foreach($penjualan as $u)
                        <tr>
                            ...
                            <td>{{ $u->alamat}}</td>
                            <td>
                                <a class="btn btn-outline-primary" href="/penjualan/edit/{{ $u->id_penjualan }}" role="button" title="Edit Data Penjualan"><i class="fas fa-fw fa-edit"></i></a>

                                <a class="btn btn-outline-danger" onclick="return confirm('Apakah Anda Yakin Menghapus Data Ini?')" href="/penjualan/hapus/{{ $u->id_penjualan }}" role="button" title="Hapus Data Penjualan"><i class="fas fa-fw fa-trash"></i></a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
